...
#run the SMOTE algorithm within the unbalanced package.

n<-ncol(train_data)
output<-as.factor(train_data$Class)
input<-train_data[ ,-n]
...
write.csv(newData, '/users/mlennox05/Documents/creditcard/balancedData_SMOTE.csv')
